...
USE_OPTIMUM_QUANTO=True  # quantize with optimum quanto
...
DOWNLOAD_FILES=True  # whether to download models
...
JOB_DIR = os.path.join('C:' + os.sep, 'deepfakes', 'df-maker-files')  # the directory to store DFS files